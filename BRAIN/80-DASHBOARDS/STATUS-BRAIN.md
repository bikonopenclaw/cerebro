...
- Brain v2 foundation, 11B, 11C, 11D e 11E estao em `origin/main`; MOC cronologico, MOCs canonicos por area, Commit Link Gate e Graph Gate estao ativos. A validacao de 2026-08-08 retornou `341` Markdown, `0` links internos quebrados, `0` uncategorized, `0` unreachable cognitive markdown, `0` isolated cognitive markdown, `1` componente de grafo e health estimate `1`; snapshots versionados seguem preservados no Git, mas fora do grafo cognitivo/Obsidian.
