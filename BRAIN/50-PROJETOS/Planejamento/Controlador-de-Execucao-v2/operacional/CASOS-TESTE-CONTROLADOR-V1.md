...
| 03 | Publicar resumo diario Bitdefender no grupo | C2/R2/G3 | aprovação explícita, rollback e parada segura |
...
| 06 | Plano PostgreSQL Etapa 1 | C3/R4/G0 | preservar escopo, validar saída e evidências |
...
| 19 | Conferir API Notaas com 28 issued | C3/R3/G0 | preservar escopo, validar saída e evidências |
| 20 | Conferir manifesto 28 emitidas e 0 erros | C0/R0/G0 | rota determinística; escalar divergência |
...
| 30 | Preparar prompt/QA Kling | C2/R3/G0 | preservar escopo, validar saída e evidências |
...
| 33 | Preparar NinjaOne read-only | C3/R3/G2 | preservar escopo, validar saída e evidências |
| 34 | Preparar ARX/Cove read-only | C3/R3/G2 | preservar escopo, validar saída e evidências |
| 35 | Preparar Bitdefender read-only | C3/R3/G2 | preservar escopo, validar saída e evidências |
...
| 38 | Canario Sentinel v1 read-only 24h | C3/R3/G3 | aprovação explícita, rollback e parada segura |
