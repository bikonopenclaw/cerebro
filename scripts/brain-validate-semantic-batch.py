...
def validate(root,baseline,manifest):
    ...
    proposals=json.loads((sys/'proposals/coverage-20260921.json').read_text())
...
def main():
    ...
    a=p.parse_args();r=validate(a.root,a.baseline,json.loads(a.manifest.read_text()))
